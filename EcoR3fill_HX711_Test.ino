/*
 * Smart Eco-R3fill - Load Cell Integration
 * Measures recyclable weight and displays water equivalent
 * Hardware: Gizduino + HX711 Load Cell + LCD I2C
 */
...
float calibrationFactor = -14000; // Corrected: was -7050, reading 50g for 99.3g object
